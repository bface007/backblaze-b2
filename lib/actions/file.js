...
exports.getFileStreamById = function (b2, args, callback) {
    var options = {
        method: "GET",
        host: getHost(b2).substring(8), // remove https://
        path: '/b2_download_file_by_id?fileId=' + args.fileId,
        headers: utils.getAuthHeaderObjectWithToken(b2)
    };
...
function getHost(b2) {
    return b2.downloadUrl + conf.API_VERSION_URL;
}
